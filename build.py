...
class RePoEDataProcessor:
    ...
    def __init__(self, use_github_pages=True):
        self.use_github_pages = use_github_pages
        if use_github_pages:
            self.base_url = "https://github.com/dkcha/PoEEasySearch"
        else:
            self.base_url = "https://raw.githubusercontent.com/dkcha/PoEEasySearch/refs/heads/main/data/base_items.json"
    
    def fetch_repoe_file(self, filename: str) -> Dict[str, Any]:
        """Fetch a RePoE data file."""
